...
## Cons
- While the scales' precision is commendable, a troubling quirk may give you pause. On rare occasions, the power button can be finicky, potentially disrupting your coffee-making ritual. Should this happen, resetting it quickly does the trick. 
- It's so small you can only fit in a single cup. This is a PRO for me,
    but might be a con for you.
- Lack of batteries means you have yet another device to be responsible
    for recharging. Again, this can be viewed as a PRO/CON depending on
    your preference.
