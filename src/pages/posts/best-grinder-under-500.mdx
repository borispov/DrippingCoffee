...
or trying to fix our miserable espresso that consistently makes us want
...
Let's examine each grinder's capabilities, features, and hopefully help
...
the ancient (compartively) aesthetics, it'd be your best bet.
...
I should state that both models are great in terms of accuracy, speed
and overall quality.
...
### Burrs
The Sette has conical burrs that are made from steel, they are long-lasting and reliable. The Sette features 40mm sized burrs. Those aren't the largest burrs, obviously, but that doesn't restrict this grinder from producing consistent results. Also, due to the design of this unit, it's quite managable to switch burrs all by yourself in case you want to use different burrs. Why one might want to do that? well, if you want to swap for burrs made for brew coffee, for instance.
...
The Baratza Sette has hopper and it isn't designed for Single Dosing,
...
revolutionary Niche Zero. Now, take the Niche Zero, cut the price in half, add massive manufacturing resources and what do you get? A grinder that is not only talked about by everyone, but also actually utilized. Let's take a quick look and see how well it competes with the rest of the contenders in our list. Long story short: It's a great grinder but will soon require modding and cost will climb up, so take that into consideration.
...
claims of zero retention, the DF64 has a very low retention when you
...
Speed wise, it's not a _fast_ grinder but it isn't a terribly slow
...
say those forks don't always hold up under the weight. Latest models
include a cup riser to help with cleanliness. It's advised to push the
bellow gently to avoid retention.

One of the best features of this grinder is modding capability and the
range of burrs you can easily swap. Additional feature I really like is an auto-off feature which I miss with my Eureka Specialita.
...
The Specialita isn't as ground breaking as DF64, Niche and others, so the
question is whether it's still relevant in 2023? Yes.
It holds up against the revolutionairs quietly with no bells and
whistles, offering great features and excellent quaity, and all of that
...
along with a continous mode which isn't restricted by time. The grinder
is relatively fast and quiet. Stock, it comes with a hopper, restricing
...
and throw the first 2g to the bin.
...
I hold the portafilter to avoid a messy surroundings because I haven't
purchased a dedicated waste/bin holder like I had with the [Profitec M54](/posts/reviews/profitec-m54/).
...
a beautiful minimalistic piece of technology which only costs 374$, but
